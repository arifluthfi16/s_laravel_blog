                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            ...
                                            <a href="{{route('category.single',['id'=>$posts[0]->category_id])}}">{{$posts[0]->category->name}}</a>
                                </span>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.single',['id'=>$posts[1]->category_id])}}">{{$posts[1]->category->name}}</a>
                                        </span>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.single',['id'=>$posts[2]->category_id])}}">{{$posts[2]->category->name}}</a>
                                        </span>
                    ...
                    <div class="offers">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">{{$ds->name}}</h4>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($ds->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
